...
This project contains automated API tests for the **[Restful Booker API](https://restful-booker.herokuapp.com/)** using **Postman** and **Newman**.  
...
- **booking-report.html** → HTML report generated by Newman after running the tests.
...
- Open Postman  
- Import `Booking API.postman_collection.json`  
- Import `Booking_Environment.postman_environment.json`  
- Select the environment before running the collection  
